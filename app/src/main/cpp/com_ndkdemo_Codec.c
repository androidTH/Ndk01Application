...
//声明遵守JNI Java 调用C的规则
JNICALL
Java_com_example_ndk01application_Codec_hexEncode(JNIEnv *env, jclass clazz, jbyteArray array) {
...
Java_com_example_ndk01application_Codec_hexDecode(JNIEnv *env, jclass type, jstring str) {
    jbyteArray ret = NULL;
